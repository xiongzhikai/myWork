  ...
  var compactShorthands = function(tokens, isImportant, processable, Token) {
    ...
    for (i = 0; i < tokens.length; i++) {
      ...
      if (processable[token.prop].isShorthand) {
        ...
        //   div{background-color:#111;background-img:url(aaa);background:linear-gradient(aaa);background-repeat:no-repeat;background-position:1px 2px;background-attachment:scroll}
